...
- [x] Locust (рекомендуется, Python-based)
...
```
- [x] UI сценарий (/api/ui/*) в `tests/load/locustfile.py`
...
- [x] Добавить черновик отчёта `PERF_REPORT.md`

#### Критерии приемки
- ✅ Нагрузочные тесты написаны
- ✅ Результаты задокументированы (черновик)
